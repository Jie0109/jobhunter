                                ...
                                <div class="card border rounded shadow mb-3">
                                    <a data-toggle="collapse" href="#collapseOne" class="faq position-relative" aria-expanded="true" aria-controls="collapseOne">
                                        <div class="card-header bg-light p-3" id="headingOne">
                                            <h4 class="title mb-0 faq-question">Do Your Research</h4>
                                        </div>
                                    </a>
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p class="text-muted mb-0 faq-ans">
                                                <ul>
                                                    <li><b>Market Rates:</b> Research the average salary for your position in your location and industry. Websites like Glassdoor, PayScale, and LinkedIn Salary can provide valuable insights.</li>
                                                    <li><b>Company Standards:</b> Understand the salary structure and benefits typically offered by the company you’re negotiating with.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card border rounded shadow mb-3">
                                    <a data-toggle="collapse" href="#collapseTwo" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapseTwo">
                                        <div class="card-header bg-light p-3" id="headingTwo">
                                            <h4 class="title mb-0 faq-question">Know Your Worth</h4>
                                        </div>
                                    </a>
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p class="text-muted mb-0 faq-ans">
                                                <ul>
                                                    <li><b>Skills and Experience:</b> Highlight your skills, experience, and achievements that make you a valuable asset to the company.</li>
                                                    <li><b>Unique Contributions:</b> Emphasize any unique contributions or expertise you bring that might justify a higher salary.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card border rounded shadow mb-3">
                                    <a data-toggle="collapse" href="#collapsethree" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsethree">
                                        <div class="card-header bg-light p-3" id="headingthree">
                                            <h4 class="title mb-0 faq-question">Prepare Your Case</h4>
                                        </div>
                                    </a>
                                    <div id="collapsethree" class="collapse" aria-labelledby="headingthree" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p class="text-muted mb-0 faq-ans">
                                                <ul>
                                                    <li><b>Accomplishments:</b> Prepare a list of your accomplishments and how they’ve benefited your previous employers.</li>
                                                    <li><b>Industry Trends:</b> Be ready to discuss industry trends and how your skills align with current demands.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card border rounded shadow mb-3">
                                    <a data-toggle="collapse" href="#collapsefour" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsefour">
                                        <div class="card-header bg-light p-3" id="headingfour">
                                            <h4 class="title mb-0 faq-question">Practice Your Pitch</h4>
                                        </div>
                                    </a>
                                    <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p class="text-muted mb-0 faq-ans">
                                                <ul>
                                                    <li><b>Role-Playing: </b>Practice negotiating with a friend or mentor to build confidence and refine your approach.</li>
                                                    <li><b>Clear and Concise: </b>Be clear and concise in presenting your case, focusing on facts and data.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card rounded shadow mb-0">
                                    <a data-toggle="collapse" href="#collapsefive" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsefive">
                                        <div class="card-header bg-light p-3" id="headingfive">
                                            <h4 class="title mb-0 faq-question">Timing Matters</h4>
                                        </div>
                                    </a>
                                    <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <p class="text-muted mb-0 faq-ans">
                                                <ul>
                                                    <li><b>Optimal Timing: </b>Find the right time to negotiate, such as after receiving a job offer but before formally accepting it.</li>
                                                    <li><b>Company’s Position: </b>Be mindful of the company’s financial situation and timing, such as end-of-quarter or fiscal year considerations.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
