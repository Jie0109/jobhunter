            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="candidates-listing-item">
                        <?php
                            $sql = "SELECT a.*, u.*, r.*, j.* FROM applicant a JOIN users u ON a.userid = u.id JOIN resume r ON a.resume = r.rid JOIN job j ON a.jobid = j.jid WHERE j.posted = ". $_SESSION['id'] ." ORDER BY j.time DESC";
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <div class="candidates-list-desc overflow-hidden job-single-meta  pt-2">
                                                    ...
                                                    <a href="candidates-listing.php?jid='.$row['jid'].'" class="btn btn-primary-outline btn-sm">Applying postion: '.$row['jname'].'</a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="candidates-list-fav-btn text-right">';
                                                    if($row['stat'] == 'Pending')
                                                    {
                                                        echo'<div class="candidates-listing-btn mt-4">
                                                            <a href="#" class="btn btn-primary-outline btn-sm">'.$row['stat'].'</a>
                                                        </div>';
                                                    }
                                                    else if($row['stat'] == 'Approved')
                                                    {
                                                        echo'<div class="candidates-listing-btn mt-4">
                                                            <a href="#" class="btn btn-primary-outline btn-sm" style="background-color: green; color: white;">'.$row['stat'].'</a>
                                                        </div>';
                                                    }
                                                    else if($row['stat'] == 'Rejected')
                                                    {
                                                        echo'<div class="candidates-listing-btn mt-4">
                                                            <a href="#" class="btn btn-primary-outline btn-sm" style="background-color: red; color: white;">'.$row['stat'].'</a>
                                                        </div>';
                                                    }
