                        ...
                        <div class="widget mb-4 pb-2">
                            ...
                            <div class="mt-4">
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-start"> <a href="jvascript:void(0)"> <img alt="img" src="images/blog-2/img-7.jpg" class="img-fluid rounded"></a></div>
                                ...
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-start"> <a href="jvascript:void(0)"> <img alt="img" src="images/blog-2/img-8.jpg" class="img-fluid rounded"></a></div>
                                ...
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-start"> <a href="jvascript:void(0)"> <img alt="img" src="images/blog-2/img-9.jpg" class="img-fluid rounded"></a></div>
                ...
                <div class="col-lg-8 col-md-6 col-12 order-1 order-md-2">
                    <div class="shadow rounded p-4">
                        <div class="blog-details-img">
                            <img src="images/blog/blog-details-img.jpg" alt="" class="img-fluid mx-auto rounded d-block">
                        </div>
                        <div class="blog-details meta mt-3">
                            <ul class="list-inline mb-1">
                                <li class="list-inline-item me-4">
                                    <p class="text-muted mb-0"><i class="mdi mdi-calendar-range me-1"></i>01-January-2018</p>
                                </li>

                                <li class="list-inline-item me-4">
                                    <p class="text-muted mb-0"><i class="mdi mdi-message-reply-text me-1"></i>4 Comments</p>
                                </li>

                                <li class="list-inline-item">
                                    <p class="text-muted mb-0"><i class="mdi mdi-layers me-1"></i>IT Jobs</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="rounded border mt-4 p-4">
                        ...
                        <div class="media mt-4 pt-2">
                            <div class="blog-comment-img">
                                <img class="d-block mx-auto rounded-pill" height="60" alt="" src="images/testi/img-6.jpg">
                            </div>
                            <div class="media-body ms-3">
                                ...
                                <div class="media mt-4">
                                    <div class="blog-comment-img">
                                        <img class="d-block mx-auto rounded-pill" height="60" alt="" src="images/testi/img-7.jpg">
                                    </div>
                                    <div class="media-body ms-3">
                        ...
                        <div class="media mt-4">
                            <div class="blog-comment-img">
                                <img class="d-block mx-auto rounded-pill" height="60" alt="" src="images/testi/img-8.jpg">
                            </div>
                            <div class="media-body ms-3">
                        ...
                        <div class="media mt-4">
                            <div class="blog-comment-img">
                                <img class="d-block mx-auto rounded-pill" height="60" alt="" src="images/testi/img-9.jpg">
                            </div>
                            <div class="media-body ms-3">
