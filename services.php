        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-md-6 mt-4 pt-2">
                            <a href="">
                                <div class="service-info-img position-relative d-block overflow-hidden">
                                    <img src="images/services/img-1.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                        ...
                        <div class="col-md-6 mt-4 pt-2">
                            <a href="">
                                <div class="service-info-img position-relative d-block overflow-hidden">
                                    <img src="images/services/img-2.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                    <div class="service-overlay">
                                        <div class="service-info text-center">
                                            <h6 class="mb-0 text-white shadow title">Clean Design</h6>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-4 pt-2">
                            <a href="">
                                <div class="service-info-img position-relative d-block overflow-hidden">
                                    <img src="images/services/img-3.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                    <div class="service-overlay">
                                        <div class="service-info text-center">
                                            <h6 class="mb-0 text-white shadow title">Clean Design</h6>
                                        </div>
                        ...
                        <div class="col-md-6 mt-4 pt-2">
                            <a href="">
                                <div class="service-info-img position-relative d-block overflow-hidden">
                                    <img src="images/services/img-4.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                    <div class="service-overlay">
                                        <div class="service-info text-center">
                                            <h6 class="mb-0 text-white shadow title">Clean Design</h6>
                                        </div>
                ...
                <div class="col-lg-6 mt-4 pt-2">
                    ...
                    <div class="mt-4">
                        <a href="#" class="btn btn-primary-outline">Read More <i class="mdi mdi-chevron-double-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
