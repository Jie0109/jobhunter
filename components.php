            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white">
                        <h4 class="text-uppercase title mb-4">Components</h4>
                        <ul class="page-next d-inline-block mb-0">
                            ...
                            <li>
                                <span class="text-uppercase text-white font-weight-bold">Components</span> 
                            </li> 
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;a href="#" class="btn btn-primary"&gt; Primary &lt;/a&gt;</code></h6>
                                    
                                    <a href="javascript:void(0)" class="btn btn-primary mb-3 me-2">Primary</a>
                                    <a href="javascript:void(0)" class="btn btn-secondary mb-3 me-2">Secondary</a>
                                    <a href="javascript:void(0)" class="btn btn-success mb-3 me-2">Success</a>
                                    <a href="javascript:void(0)" class="btn btn-danger mb-3 me-2">Danger</a>
                                    <a href="javascript:void(0)" class="btn btn-info mb-3 me-2">Info</a>
                                    <a href="javascript:void(0)" class="btn btn-warning mb-3 me-2">Warning</a>
                                    <a href="javascript:void(0)" class="btn btn-light mb-3 me-2">Light</a>
                                    <a href="javascript:void(0)" class="btn btn-dark mb-3 me-2">Dark</a>
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;a href="#" class="btn btn-primary rounded-pill"&gt; Primary &lt;/a&gt;</code></h6>

                                    <a href="javascript:void(0)" class="btn btn-primary rounded-pill mb-3 me-2">Primary</a>
                                    <a href="javascript:void(0)" class="btn btn-secondary rounded-pill mb-3 me-2">Secondary</a>
                                    <a href="javascript:void(0)" class="btn btn-success rounded-pill mb-3 me-2">Success</a>
                                    <a href="javascript:void(0)" class="btn btn-danger rounded-pill mb-3 me-2">Danger</a>
                                    <a href="javascript:void(0)" class="btn btn-info rounded-pill mb-3 me-2">Info</a>
                                    <a href="javascript:void(0)" class="btn btn-warning rounded-pill mb-3 me-2">Warning</a>
                                    <a href="javascript:void(0)" class="btn btn-light rounded-pill mb-3 me-2">Light</a>
                                    <a href="javascript:void(0)" class="btn btn-dark rounded-pill mb-3 me-2">Dark</a>
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;a href="#" class="btn btn-primary-outline"&gt; Primary &lt;/a&gt;</code></h6>

                                    <a href="javascript:void(0)" class="btn btn-primary-outline mb-3 me-2">Primary</a>
                                    <a href="javascript:void(0)" class="btn btn-secondary-outline mb-3 me-2">Secondary</a>
                                    <a href="javascript:void(0)" class="btn btn-success-outline mb-3 me-2">Success</a>
                                    <a href="javascript:void(0)" class="btn btn-danger-outline mb-3 me-2">Danger</a>
                                    <a href="javascript:void(0)" class="btn btn-info-outline mb-3 me-2">Info</a>
                                    <a href="javascript:void(0)" class="btn btn-warning-outline mb-3 me-2">Warning</a>
                                    <a href="javascript:void(0)" class="btn btn-light-outline mb-3 me-2">Light</a>
                                    <a href="javascript:void(0)" class="btn btn-dark-outline mb-3 me-2">Dark</a>
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;a href="#" class="btn btn-primary btn-sm"&gt; Primary &lt;/a&gt;</code></h6>

                                    <a href="javascript:void(0)" class="btn btn-primary btn-sm mb-3 me-2">Primary</a>
                                    <a href="javascript:void(0)" class="btn btn-warning mb-3 me-2">Warning</a>
                                    <a href="javascript:void(0)" class="btn btn-success btn-lg mb-3 me-2">Success</a>
                                </div>
                            </div>
                        </div><!--end col-->
                                            ...
                                            <div class="card border rounded shadow mb-2">
                                                <a data-toggle="collapse" href="#collapseOne" class="faq position-relative" aria-expanded="true" aria-controls="collapseOne">
                                                    <div class="card-header bg-light p-3" id="headingOne">
                                                        <h4 class="title mb-0 faq-question"> Accordion #1 </h4>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="card border rounded shadow mb-2">
                                                <a data-toggle="collapse" href="#collapseTwo" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapseTwo">
                                                    <div class="card-header bg-light p-3" id="headingTwo">
                                                        <h4 class="title mb-0 faq-question"> Accordion #2 </h4>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="card rounded shadow mb-0">
                                                <a data-toggle="collapse" href="#collapsefive" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsefive">
                                                    <div class="card-header bg-light p-3" id="headingfive">
                                                        <h4 class="title mb-0 faq-question"> Accordion #3 </h4>
                                                    </div>
                                                </a>
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                <div class="p-4 border-bottom bg-light">
                                    <h4 class="title mb-0"> Avatars </h4>
                                </div>
    
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;img src="images/home/01.jpg" class="img-fluid avatar avatar-small me-3 rounded-pill"&gt;</code></h6>
                                    
                                    <img src="images/team/img-1.jpg" class="img-fluid avatar avatar-small me-3 rounded-pill" alt="">
                                    <img src="images/team/img-1.jpg" class="img-fluid avatar avatar-medium me-3 rounded-pill" alt="">
                                    <img src="images/team/img-1.jpg" class="img-fluid avatar avatar-large me-3 rounded-pill" alt="">
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <div class="map">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" class="rounded" style="border:0" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div><!--end col-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <ul class="nav nav-pills nav nav-pills bg-white rounded nav-justified flex-column flex-sm-row" id="pills-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link rounded active" id="pills-cloud-tab" data-toggle="pill" href="#pills-cloud" role="tab" aria-controls="pills-cloud" aria-selected="true">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link rounded" id="pills-smart-tab" data-toggle="pill" href="#pills-smart" role="tab" aria-controls="pills-smart" aria-selected="false">About</a>
                                                </li>
                                                <li class="nav-item">
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4 bg-dark rounded-bottom page-next-level">
                                    <ul class="page-next d-inline-block mb-0">
                            ...
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination mb-0 job-pagination">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;span class="badge badge-primary"&gt; primary &lt;/span&gt;</code></h6>

                                    <span class="badge badge-primary me-2 mb-2">Primary</span>
                                    <span class="badge badge-secondary me-2 mb-2">Secondary</span>
                                    <span class="badge badge-success me-2 mb-2">Success</span>
                                    <span class="badge badge-danger me-2 mb-2">Danger</span>
                                    <span class="badge badge-warning me-2 mb-2">Warning</span>
                                    <span class="badge badge-info me-2 mb-2">Info</span>
                                    <span class="badge badge-light me-2 mb-2">Light</span>
                                    <span class="badge badge-dark me-2 mb-2">Dark</span>
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-12 mt-4 pt-2">
                            <div class="component-wrapper rounded shadow">
                                ...
                                <div class="p-4">
                                    <h6 class="text-muted mb-4 pb-2">Ex. <code class="text-danger">&lt;span class="badge badge-primary rounded"&gt; primary &lt;/span&gt;</code></h6>

                                    <span class="badge badge-primary rounded me-2 mb-2">Primary</span>
                                    <span class="badge badge-secondary rounded me-2 mb-2">Secondary</span>
                                    <span class="badge badge-success rounded me-2 mb-2">Success</span>
                                    <span class="badge badge-danger rounded me-2 mb-2">Danger</span>
                                    <span class="badge badge-warning rounded me-2 mb-2">Warning</span>
                                    <span class="badge badge-info rounded me-2 mb-2">Info</span>
                                    <span class="badge badge-light rounded me-2 mb-2">Light</span>
                                    <span class="badge badge-dark rounded me-2 mb-2">Dark</span>
                                </div>
                            </div>
                        </div><!--end col-->
