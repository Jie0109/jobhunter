<?php
    ...
    //<td><video src="'.$vids_path.'" width="320" height="240" controls></video></td>
    ...
    if(isset($_POST['save']))
    {
        ...
        if(empty($_POST['ocup']))
        {
            $ocupErr = "Please enter your occupation.";
        }
        else
        {
            $ocup = $_POST['ocup'];
        ...
        {
            $sql = "UPDATE users SET place = '$from', ocup = '$ocup', salary = '$salary' WHERE id = " . $_SESSION['id'];
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="candidates-profile-details text-center">
                        <img src="images/team/img-1.jpg" height="150" alt="" class="d-block mx-auto shadow rounded-pill mb-4">
                ...
                <div class="col-lg-12 mt-3">
                    <div class="border rounded p-4">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM resume WHERE uids = ".$_SESSION['id'];
                                $result = mysqli_query($link, $sql);
                                $counter = 1;
                                if(mysqli_num_rows($result)>0)
                                {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        <tr>
                                            <td>'. $counter . '.</td>
                                            <td>'.$row['resume'].'</td>
                                            <td><a href="'.$file_path.'" class="btn btn-primary" target="_blank">View</a></td>
                                            <td><video src="'.$vids_path.'" width="320" height="240" controls></video></td>
                                        </tr>
                                        ';
                                        $counter++;
                    ...
                    <form method="post">
                        <div class="border rounded p-4">
                            <div class="job-detail-desc">
                                ...
                                $row = mysqli_fetch_assoc($result);
                                ?>
                                <input id="title-name" type="text" class="form-control resume" placeholder="Where do you from?" name="from" value="<?=$row['place']?>"><br>
                                <span class="invalid-feedback d-block"><?php echo $fromErr; ?></span>
                                <input id="title-name" type="text" class="form-control resume" placeholder="Occupation" name="ocup" value="<?=$row['ocup']?>"><br>
