        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-1.jpg" alt="" class="img-fluid d-block rounded">
                        ...
                        <div class="team-content text-center pb-0 pt-3">
                            <div class="">
                                <p class="mb-0"><a href="#" class="text-dark font-weight-bold">Web Developer</a></p>
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        ...
                        <div class="team-content text-center pb-0 pt-3">
                            <div class="">
                                <p class="mb-0"><a href="#" class="text-dark font-weight-bold">Graphic Designer</a></p>
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        ...
                        <div class="team-content text-center pb-0 pt-3">
                            <div class="">
                                <p class="mb-0"><a href="#" class="text-dark font-weight-bold">Web Designer</a></p>
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        ...
                        <div class="team-content text-center pb-0 pt-3">
                            <div class="">
                                <p class="mb-0"><a href="#" class="text-dark font-weight-bold">UI/UX Designer</a></p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        ...
                        <div class="team-content text-center pb-0 pt-3">
                            <div class="">
                                <p class="mb-0"><a href="#" class="text-dark font-weight-bold">PHP Developer</a></p>
                                <p class="text-muted mb-0">Phasellus ullamcorper ipsum nunc nunc nonummy metus.</p>
                                <ul class="list-unstyled social-icon mt-3 mb-0">
                                    <li class="list-inline-item"><a href="#" class="rounded"><i class="mdi mdi-facebook"></i></a></li>
                                    <li class="list-inline-item"><a href="#" class="rounded"><i class="mdi mdi-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-6.jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-7.jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-8.jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-9.jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-3 (1).jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-2 (1).jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="team-box position-relative overflow-hidden text-center bg-white">
                        <div class="team-img position-relative overflow-hidden d-block">
                            <img src="images/team/img-1 (1).jpg" alt="" class="img-fluid d-block rounded">
                            <div class="team-name p-2 rounded-bottom">
