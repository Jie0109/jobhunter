                    ...
                    <div class="text-sm-center">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item me-3">
                                <p class="text-muted mb-0"><i class="mdi mdi-map-marker me-2"></i>4102 Aviation Way Los Angeles, CA 90017</p>
                            </li>

                            <li class="list-inline-item">
                                <p class="text-success mb-0"><i class="mdi mdi-bookmark-check mdi-18px me-2"></i>Verified</p>
                            </li>
                        </ul>

                        <ul class="list-inline mb-2">
                            <li class="list-inline-item me-3 ">
                                <p class="text-muted"><i class="mdi mdi-earth me-2"></i>Themescodeltd.co.in</p>
                            </li>

                            <li class="list-inline-item me-3">
                                <p class="text-muted"><i class="mdi mdi-email me-2"></i>Themescodeltd2018@gmail.com</p>
                            </li>

                            <li class="list-inline-item">
                                <p class="text-muted"><i class="mdi mdi-cellphone-iphone me-2"></i>123 456 7890</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="shadow rounded p-4 mt-4">
                        <img src="images/team/img-1.jpg" alt="" height="90" class="float-start shadow rounded-pill me-3">
                        <div class="d-block overflow-hidden">
                            <h6 class="text-muted font-weight-light float-end mb-0"><i class="mdi mdi-clock-outline me-1"></i>32 minutes ago</h6>
                            ...
                            <ul class="employers-icons list-inline mb-1">
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                    ...
                    <div class="shadow rounded p-4 mt-4">
                        <img src="images/team/img-2.jpg" alt="" height="90" class="float-start shadow rounded-pill me-3">
                        <div class="d-block overflow-hidden">
                            <h6 class="text-muted font-weight-light float-end mb-0"><i class="mdi mdi-clock-outline me-1"></i>49 minutes ago</h6>
                            <h5 class="mb-1"><a href="#" class="text-dark">Mario Thomas</a></h5>
                            <small class="text-muted font-weight-bold">Web Developer</small>
                            <ul class="employers-icons list-inline mb-1">
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                    ...
                    <div class="shadow rounded p-4 mt-4">
                        <img src="images/team/img-3.jpg" alt="" height="90" class="float-start shadow rounded-pill me-3">
                        <div class="d-block overflow-hidden">
                            <h6 class="text-muted font-weight-light float-end mb-0"><i class="mdi mdi-clock-outline me-1"></i>1 Days Ago</h6>
                            <h5 class="mb-1"><a href="#" class="text-dark">Mario Thomas</a></h5>
                            <small class="text-muted font-weight-bold">Web Developer</small>
                            <ul class="employers-icons list-inline mb-1">
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
                    ...
                    <div class="shadow rounded p-4 mt-4">
                        <img src="images/team/img-4.jpg" alt="" height="90" class="float-start shadow rounded-pill me-3">
                        <div class="d-block overflow-hidden">
                            <h6 class="text-muted font-weight-light float-end mb-0"><i class="mdi mdi-clock-outline me-1"></i>3 Day Ago</h6>
                            <h5 class="mb-1"><a href="#" class="text-dark">Mario Thomas</a></h5>
                            <small class="text-muted font-weight-bold">Web Developer</small>
                            <ul class="employers-icons list-inline mb-1">
                                <li class="list-inline-item me-0 text-success"><i class="mdi mdi-star"></i></li>
