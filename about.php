...
?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <p class="mb-4 f-16"><a href="" class="text-muted"><i class="mdi mdi-earth me-2"></i>Themescodeltd.co.in</a></p>
    ...
    <!-- DOWNLOAD APP START -->
    <section class="section pb-0" style="background: url('images/bg-counters.jpg') center center;">
        <div class="bg-overlay"></div>
        <div class="container">
            <div class="row align-items-center">
